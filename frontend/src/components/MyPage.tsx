...
import { User, School, GraduationCap, CheckCircle, Award, Trophy, Bell, ChevronRight, X } from 'lucide-react';
...
export function MyPage({ onNavigateToActivityHistory, onNavigateToProfileDetail, onNavigateToBookmarkedNotices, onNavigateToParticipatedNotices, onCompleteNotice, participatedCount = 0, participatedNotices = [], completedActivities = [] }: MyPageProps = {}) {
