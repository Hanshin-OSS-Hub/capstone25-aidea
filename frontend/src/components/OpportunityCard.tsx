...
import { Calendar, Award, Trophy, Bell } from 'lucide-react';
...
export function OpportunityCard({ opportunity, onClick, isParticipated = false, onParticipate }: OpportunityCardProps) {
